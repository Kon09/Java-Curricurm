...
public class Practice {
	...
	public static void main(String[] args) {
		...
		double ja = (double)(test[0][0] + test[1][0] + test[2][0] + test[3][0]) / test.length;
		double ma = (double)(test[0][1] + test[1][1] + test[2][1] + test[3][1]) / test.length;
		double en = (double)(test[0][2] + test[1][2] + test[2][2] + test[3][2]) / test.length;
		System.out.println("国語の平均点は" + ja + "点です。");
		System.out.println("数学の平均点は" + ma + "点です。");
		System.out.println("英語の平均点は" + en + "点です。");
	}
